...
1. Download the latest Linux release bundle (`ROMCat-v0.5.8-linux-x86_64.tar.gz` or `.zip`) from the [Releases page](https://github.com/PlasmaDrifter/Emulator-Web-Catelog/releases).
2. Extract the archive:
   ```bash
   tar -xzf ROMCat-v0.5.8-linux-x86_64.tar.gz
   cd Standalone.app
   ```
